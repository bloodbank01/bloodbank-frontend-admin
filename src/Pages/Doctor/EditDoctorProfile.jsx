...
import { doctorProfile } from '../../Redux/Action';
...
const EditDoctorProfile = () => {
    ...
    const profile = useSelector(state => state.handle.doctorProfile);
        ...
        (async () => {
            try {
                ...
                if (response.status) {
                    ...
                    dispatch(doctorProfile(response.data))
    ...
    const validationSchema = Yup.object({
        ...
        description: Yup.string().min(3, 'Minimum length should be 3').required('Required'),
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="profile-img-wrap">
                                                {profilePic && <img style={{ objectFit: 'cover' }} className="inline-block" src={profilePic} alt="user" />}
