...
import { addBloodGroup } from '../../Common/Apis/ApiService';
...
const AddBloodGroup = () => {
    ...
    const validationSchema = Yup.object({
        name: Yup.string().required('Blood Group Name is required'),
    });
    ...
    const handleSubmit = async (data) => {
        try {
            startLoading()
            const response = await addBloodGroup(data)
            stopLoading()
            if (response.status) {
                            ...
                            <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    <li className="breadcrumb-item">
                                        <Link to="/admin/blood-group/list">Blood Groups </Link>
                                    </li>
                                    <li className="breadcrumb-item">
                                        <i className="feather-chevron-right" />
                                    </li>
                                    <li className="breadcrumb-item active">Add Blood Group</li>
                                </ul>
                            </div>
                        </div>
                    </div>
